...
export function NodeColorLegend({ magNES, width, height, svgID }) {
  const nesText = (Math.round((magNES || 1.0) * 100) / 100).toFixed(2);
  return (
    <div>
      <svg id={svgID} width={width} height={height} viewBox="8.875 14.117 111.582 211.957" xmlns="http://www.w3.org/2000/svg">
        <defs>
        ...
        <text style={{whiteSpace: 'pre', fill: 'rgb(51, 51, 51)', fontFamily: 'Arial, sans-serif', fontSize: '15.2px'}} x="34.511" y="34.479">NES</text>
...
export function EdgeWidthLegend({ width, height, svgID }) {
  return (
    <div>
      <svg id={svgID} width={width} height={height} viewBox="0 0 119.499 226.233" xmlns="http://www.w3.org/2000/svg">
